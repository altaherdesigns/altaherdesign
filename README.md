...
[![Deployed on Cloudflare Pages](https://img.shields.io/badge/Deployed%20on-Cloudflare%20Pages-F38020?logo=cloudflare&logoColor=white)](https://altaherdesign.ae)
[![Website Status](https://img.shields.io/website?url=https%3A%2F%2Faltaherdesign.ae)](https://altaherdesign.ae)
[![Language](https://img.shields.io/badge/Language-EN%20%2F%20AR-1B5E6B)](https://altaherdesign.ae)

**Live:** https://altaherdesign.ae  
**Arabic:** https://altaherdesign.ae/ar/  

Official source code for altaherdesign.ae — the website of Al Taher Group, a Fujairah-based industrial group established in 1984 specialising in aluminium works, carpentry, metal fabrication, powder coating, custom gates, stair railings, kitchen design and pergolas across all seven UAE emirates.
...
| Domain | altaherdesign.ae (Cloudflare DNS) |
...
**Hours:** Sat–Thu 6:00 AM – 9:00 PM · Friday closed
...
Auto-deploys to altaherdesign.ae on every push to `main` via Cloudflare Pages.
